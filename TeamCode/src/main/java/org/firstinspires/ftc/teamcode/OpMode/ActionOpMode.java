...
//        );
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.dpad_up && flagDpadUp) {
                // most extended
                horizontalAction = elevators.setHorizontalElevatorAction(Elevators.HorizontalState.HORIZONTAL_EXTENDED);
            } else if (gamepad2.dpad_left && flagDpadLeft) {
                // halfway extended
                horizontalAction = elevators.setHorizontalElevatorAction(Elevators.HorizontalState.HORIZONTAL_HALFWAY);
            } else if (gamepad2.dpad_down && flagDpadDown) {
                // most retracted
                horizontalAction = elevators.setHorizontalElevatorAction(Elevators.HorizontalState.HORIZONTAL_RETRACTED);
            }

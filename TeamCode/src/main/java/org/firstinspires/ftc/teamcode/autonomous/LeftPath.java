...
public class LeftPath extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        TrajectoryActionBuilder B_sample1pickup = B_preload.endTrajectory().fresh()
                ...
                .strafeToSplineHeading(new Vector2d(firstSampleX + sampleOffset1,collectLine), 0.5*Math.PI, new TranslationalVelConstraint(10));
        ...
        TrajectoryActionBuilder B_sample2pickup = B_sample1basket.endTrajectory().fresh()
                ...
                .strafeToSplineHeading(new Vector2d(firstSampleX + sampleOffset2, collectLine - 5), 0.5*Math.PI, new TranslationalVelConstraint(10));
